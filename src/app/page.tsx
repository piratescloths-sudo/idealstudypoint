          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24 max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div className="relative">
                <div className="relative h-[500px] md:h-[600px] w-full rounded-[3rem] overflow-hidden shadow-xl">
                  <Image
                ...
                <div className="absolute -bottom-10 -right-6 bg-indigo-600 text-white p-10 rounded-[2.5rem] shadow-xl shadow-indigo-600/30 flex flex-col items-center justify-center text-center min-w-[200px]">
                  <span className="text-5xl font-headline font-bold">25+</span>
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] mt-2">Years of Excellence</span>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <h2 className="text-5xl md:text-7xl font-headline font-bold text-slate-900 tracking-tighter leading-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                  {["Expert Faculty", "Modern Campus", "Flexible Learning", "Career Support"].map((feature, i) => (
                    <div key={i} className="flex items-center gap-4">
                      <div className="h-3 w-3 rounded-full bg-indigo-600 shadow-lg shadow-indigo-600/20" />
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24 max-w-7xl">
            <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
              <div className="space-y-4 text-center md:text-left">
                ...
                <h2 className="text-5xl md:text-7xl font-headline font-bold text-slate-900 tracking-tighter">Our Programs</h2>
              ...
              <Button asChild variant="ghost" className="text-indigo-600 font-bold text-lg hover:bg-indigo-50 px-8 h-14 rounded-2xl gap-3 transition-all">
                ...
                <Card key={idx} className="group overflow-hidden border-none shadow-2xl hover:shadow-3xl transition-all duration-500 rounded-[3rem] bg-white">
                  <div className="relative h-64 w-full overflow-hidden">
                    ...
                    <div className="absolute top-6 left-6">
                      <span className="bg-indigo-600 text-white text-[10px] font-black uppercase tracking-[0.15em] px-5 py-2 rounded-full shadow-lg">Trending</span>
                    </div>
                  </div>
                  <CardContent className="p-10 space-y-6">
                    ...
                    <div className="flex items-center gap-4 text-slate-500 font-bold text-[13px] bg-slate-50 w-fit px-5 py-2.5 rounded-2xl">
        ...
        <section className="py-32 bg-white">
          <div className="container mx-auto px-6 md:px-12 lg:px-24 max-w-7xl">
            <div className="text-center mb-20 space-y-6 max-w-4xl mx-auto">
              ...
              <h2 className="text-5xl md:text-7xl font-headline font-bold text-slate-900 leading-tight tracking-tighter">Upcoming Events</h2>
                ...
                <Card key={idx} className="group overflow-hidden border-none shadow-2xl hover:shadow-3xl transition-all duration-500 rounded-[3rem] bg-white">
                  <div className="relative h-72 w-full">
                    ...
                    <div className="absolute top-8 right-8">
                      <span className="bg-secondary text-white text-[11px] font-black uppercase tracking-[0.15em] px-6 py-3 rounded-full shadow-lg">Upcoming</span>
                    </div>
                    <div className="absolute bottom-8 left-8 bg-white rounded-2xl p-6 shadow-2xl flex flex-col items-center justify-center min-w-[80px]">
            ...
            <div className="mt-20 flex justify-center">
              <Button asChild variant="outline" className="h-16 px-12 rounded-2xl font-bold border-slate-200 hover:bg-slate-50 gap-4 transition-all text-xl">
        ...
        <section className="py-32 bg-[#F8FAFC]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-20 space-y-6 max-w-4xl mx-auto">
              ...
              <h2 className="text-5xl md:text-7xl font-headline font-bold text-slate-900 tracking-tighter leading-tight">What Our Students Say</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto">
              {testimonials.map((t, idx) => (
                <Card key={idx} className="border-none shadow-2xl rounded-[3.5rem] bg-white p-12 flex flex-col justify-between h-full transition-transform hover:-translate-y-4 duration-300">
                  <div className="space-y-8">
                    <div className="h-16 w-16 flex items-center justify-center rounded-2xl bg-indigo-50/50">
                      <Quote className="h-8 w-8 text-indigo-200" />
                    </div>
                    <p className="text-xl text-slate-600 font-medium leading-relaxed italic">&quot;{t.text}&quot;</p>
                  </div>
                  ...
                  <div className="pt-12 flex items-center justify-between mt-auto">
                    <div className="flex items-center gap-5">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-1">{t.role}</span>
                      </div>
                    </div>
